...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<activerecord>, ["~> 3.1", "~> 3.2"])
      s.add_runtime_dependency(%q<activesupport>, ["~> 3.1", "~> 3.2"])
      s.add_runtime_dependency(%q<polyamorous>, ["~> 0.5.0"])
      s.add_runtime_dependency(%q<actionpack>, ["~> 3.1", "~> 3.2"])
    else
      s.add_dependency(%q<shoulda>, [">= 0"])
      s.add_dependency(%q<rake>, [">= 0"])
      s.add_dependency(%q<sqlite3>, [">= 0"])
      s.add_dependency(%q<activerecord>, ["~> 3.1", "~> 3.2"])
      s.add_dependency(%q<activesupport>, ["~> 3.1", "~> 3.2"])
      s.add_dependency(%q<polyamorous>, ["~> 0.5.0"])
      s.add_dependency(%q<actionpack>, ["~> 3.1", "~> 3.2"])
    end
  else
    s.add_dependency(%q<shoulda>, [">= 0"])
    s.add_dependency(%q<rake>, [">= 0"])
